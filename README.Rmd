...
R data package for the [Uppsala Conflict Data Program](https://ucdp.uu.se/downloads/)
...
The following are some examples of questions that the Georeferenced Event Dataset may help investigate.
